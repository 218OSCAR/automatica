...
// IWYU pragma: private, include "zivid_interfaces/srv/hand_eye_calibration_calibrate.h"


#ifndef ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CALIBRATE__FUNCTIONS_H_
#define ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CALIBRATE__FUNCTIONS_H_
...
/// Initialize srv/HandEyeCalibrationCalibrate message.
/**
...
/// Finalize srv/HandEyeCalibrationCalibrate message.
/**
...
/// Create srv/HandEyeCalibrationCalibrate message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__init().
...
/// Destroy srv/HandEyeCalibrationCalibrate message.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__fini()
...
/// Check for srv/HandEyeCalibrationCalibrate message equality.
/**
...
/// Copy a srv/HandEyeCalibrationCalibrate message.
/**
...
/// Initialize array of srv/HandEyeCalibrationCalibrate messages.
/**
...
/// Finalize array of srv/HandEyeCalibrationCalibrate messages.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__fini()
...
/// Create array of srv/HandEyeCalibrationCalibrate messages.
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/HandEyeCalibrationCalibrate messages.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/HandEyeCalibrationCalibrate message array equality.
/**
...
/// Copy an array of srv/HandEyeCalibrationCalibrate messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CALIBRATE__FUNCTIONS_H_
