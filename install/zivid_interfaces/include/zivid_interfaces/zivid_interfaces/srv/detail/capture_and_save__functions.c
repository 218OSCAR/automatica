...
zivid_interfaces__srv__CaptureAndSave_Request__init(zivid_interfaces__srv__CaptureAndSave_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->file_path)) {
    zivid_interfaces__srv__CaptureAndSave_Request__fini(msg);
    return false;
  }
  return true;
}
...
zivid_interfaces__srv__CaptureAndSave_Request__create(void)
{
  ...
  zivid_interfaces__srv__CaptureAndSave_Request * msg = (zivid_interfaces__srv__CaptureAndSave_Request *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zivid_interfaces__srv__CaptureAndSave_Request));
  bool success = zivid_interfaces__srv__CaptureAndSave_Request__init(msg);
  if (!success) {
...
zivid_interfaces__srv__CaptureAndSave_Request__Sequence__init(zivid_interfaces__srv__CaptureAndSave_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Request * data = NULL;

  if (size) {
    data = (zivid_interfaces__srv__CaptureAndSave_Request *)allocator.zero_allocate(size, sizeof(zivid_interfaces__srv__CaptureAndSave_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zivid_interfaces__srv__CaptureAndSave_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        zivid_interfaces__srv__CaptureAndSave_Request__fini(&data[i - 1]);
      }
...
zivid_interfaces__srv__CaptureAndSave_Request__Sequence__fini(zivid_interfaces__srv__CaptureAndSave_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      zivid_interfaces__srv__CaptureAndSave_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Request__Sequence * array = (zivid_interfaces__srv__CaptureAndSave_Request__Sequence *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zivid_interfaces__srv__CaptureAndSave_Request__Sequence__init(array, size);
  if (!success) {
...
zivid_interfaces__srv__CaptureAndSave_Request__Sequence__destroy(zivid_interfaces__srv__CaptureAndSave_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zivid_interfaces__srv__CaptureAndSave_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zivid_interfaces__srv__CaptureAndSave_Request__Sequence__are_equal(const zivid_interfaces__srv__CaptureAndSave_Request__Sequence * lhs, const zivid_interfaces__srv__CaptureAndSave_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zivid_interfaces__srv__CaptureAndSave_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zivid_interfaces__srv__CaptureAndSave_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zivid_interfaces__srv__CaptureAndSave_Request * data =
      (zivid_interfaces__srv__CaptureAndSave_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zivid_interfaces__srv__CaptureAndSave_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zivid_interfaces__srv__CaptureAndSave_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Request__copy(
...
zivid_interfaces__srv__CaptureAndSave_Response__init(zivid_interfaces__srv__CaptureAndSave_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    zivid_interfaces__srv__CaptureAndSave_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Response * msg = (zivid_interfaces__srv__CaptureAndSave_Response *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zivid_interfaces__srv__CaptureAndSave_Response));
  bool success = zivid_interfaces__srv__CaptureAndSave_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
zivid_interfaces__srv__CaptureAndSave_Response__Sequence__init(zivid_interfaces__srv__CaptureAndSave_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Response * data = NULL;

  if (size) {
    data = (zivid_interfaces__srv__CaptureAndSave_Response *)allocator.zero_allocate(size, sizeof(zivid_interfaces__srv__CaptureAndSave_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zivid_interfaces__srv__CaptureAndSave_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        zivid_interfaces__srv__CaptureAndSave_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
zivid_interfaces__srv__CaptureAndSave_Response__Sequence__fini(zivid_interfaces__srv__CaptureAndSave_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      zivid_interfaces__srv__CaptureAndSave_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Response__Sequence * array = (zivid_interfaces__srv__CaptureAndSave_Response__Sequence *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zivid_interfaces__srv__CaptureAndSave_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
zivid_interfaces__srv__CaptureAndSave_Response__Sequence__destroy(zivid_interfaces__srv__CaptureAndSave_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zivid_interfaces__srv__CaptureAndSave_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zivid_interfaces__srv__CaptureAndSave_Response__Sequence__are_equal(const zivid_interfaces__srv__CaptureAndSave_Response__Sequence * lhs, const zivid_interfaces__srv__CaptureAndSave_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zivid_interfaces__srv__CaptureAndSave_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zivid_interfaces__srv__CaptureAndSave_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zivid_interfaces__srv__CaptureAndSave_Response * data =
      (zivid_interfaces__srv__CaptureAndSave_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zivid_interfaces__srv__CaptureAndSave_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zivid_interfaces__srv__CaptureAndSave_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
zivid_interfaces__srv__CaptureAndSave_Event__init(zivid_interfaces__srv__CaptureAndSave_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    zivid_interfaces__srv__CaptureAndSave_Event__fini(msg);
    return false;
  }
  // request
  if (!zivid_interfaces__srv__CaptureAndSave_Request__Sequence__init(&msg->request, 0)) {
    zivid_interfaces__srv__CaptureAndSave_Event__fini(msg);
    return false;
  }
  // response
  if (!zivid_interfaces__srv__CaptureAndSave_Response__Sequence__init(&msg->response, 0)) {
    zivid_interfaces__srv__CaptureAndSave_Event__fini(msg);
    return false;
  }
  return true;
...
zivid_interfaces__srv__CaptureAndSave_Event__fini(zivid_interfaces__srv__CaptureAndSave_Event * msg)
{
  ...
  // request
  zivid_interfaces__srv__CaptureAndSave_Request__Sequence__fini(&msg->request);
  // response
  zivid_interfaces__srv__CaptureAndSave_Response__Sequence__fini(&msg->response);
}
...
zivid_interfaces__srv__CaptureAndSave_Event__are_equal(const zivid_interfaces__srv__CaptureAndSave_Event * lhs, const zivid_interfaces__srv__CaptureAndSave_Event * rhs)
{
  ...
  // request
  if (!zivid_interfaces__srv__CaptureAndSave_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!zivid_interfaces__srv__CaptureAndSave_Response__Sequence__are_equal(
  ...
  zivid_interfaces__srv__CaptureAndSave_Event * output)
{
  ...
  // request
  if (!zivid_interfaces__srv__CaptureAndSave_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!zivid_interfaces__srv__CaptureAndSave_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Event * msg = (zivid_interfaces__srv__CaptureAndSave_Event *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(zivid_interfaces__srv__CaptureAndSave_Event));
  bool success = zivid_interfaces__srv__CaptureAndSave_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
zivid_interfaces__srv__CaptureAndSave_Event__Sequence__init(zivid_interfaces__srv__CaptureAndSave_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Event * data = NULL;

  if (size) {
    data = (zivid_interfaces__srv__CaptureAndSave_Event *)allocator.zero_allocate(size, sizeof(zivid_interfaces__srv__CaptureAndSave_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = zivid_interfaces__srv__CaptureAndSave_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        zivid_interfaces__srv__CaptureAndSave_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
zivid_interfaces__srv__CaptureAndSave_Event__Sequence__fini(zivid_interfaces__srv__CaptureAndSave_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      zivid_interfaces__srv__CaptureAndSave_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  zivid_interfaces__srv__CaptureAndSave_Event__Sequence * array = (zivid_interfaces__srv__CaptureAndSave_Event__Sequence *)allocator.allocate(sizeof(zivid_interfaces__srv__CaptureAndSave_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = zivid_interfaces__srv__CaptureAndSave_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
zivid_interfaces__srv__CaptureAndSave_Event__Sequence__destroy(zivid_interfaces__srv__CaptureAndSave_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    zivid_interfaces__srv__CaptureAndSave_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
zivid_interfaces__srv__CaptureAndSave_Event__Sequence__are_equal(const zivid_interfaces__srv__CaptureAndSave_Event__Sequence * lhs, const zivid_interfaces__srv__CaptureAndSave_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  zivid_interfaces__srv__CaptureAndSave_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(zivid_interfaces__srv__CaptureAndSave_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    zivid_interfaces__srv__CaptureAndSave_Event * data =
      (zivid_interfaces__srv__CaptureAndSave_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!zivid_interfaces__srv__CaptureAndSave_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          zivid_interfaces__srv__CaptureAndSave_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!zivid_interfaces__srv__CaptureAndSave_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
