...
enum
{
  zivid_interfaces__srv__CaptureAndSave_Event__request__MAX_SIZE = 1
};
// response
enum
{
  zivid_interfaces__srv__CaptureAndSave_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/CaptureAndSave in the package zivid_interfaces.
typedef struct zivid_interfaces__srv__CaptureAndSave_Event
{
  service_msgs__msg__ServiceEventInfo info;
  zivid_interfaces__srv__CaptureAndSave_Request__Sequence request;
  zivid_interfaces__srv__CaptureAndSave_Response__Sequence response;
} zivid_interfaces__srv__CaptureAndSave_Event;

// Struct for a sequence of zivid_interfaces__srv__CaptureAndSave_Event.
typedef struct zivid_interfaces__srv__CaptureAndSave_Event__Sequence
{
