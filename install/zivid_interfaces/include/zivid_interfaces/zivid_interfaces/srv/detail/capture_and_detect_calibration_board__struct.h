...
enum
{
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event__request__MAX_SIZE = 1
};
// response
enum
{
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/CaptureAndDetectCalibrationBoard in the package zivid_interfaces.
typedef struct zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event
{
  service_msgs__msg__ServiceEventInfo info;
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request__Sequence request;
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response__Sequence response;
} zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event;

// Struct for a sequence of zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event.
typedef struct zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event__Sequence
{
