...
void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__init(message_memory);
}

void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_fini_function(void * message_memory)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__fini(message_memory);
}

size_t zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__size_function__HandEyeCalibrationCalibrate_Event__request(
  const void * untyped_member)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence * member =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__request(
  const void * untyped_member, size_t index)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence * member =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence *)(untyped_member);
...
void * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__request(
  void * untyped_member, size_t index)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence * member =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__fetch_function__HandEyeCalibrationCalibrate_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request * item =
    ((const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request *)
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__request(untyped_member, index));
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request * value =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request *)(untyped_value);
  *value = *item;
}

void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__assign_function__HandEyeCalibrationCalibrate_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request * item =
    ((zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request *)
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__request(untyped_member, index));
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request * value =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request *)(untyped_value);
  *item = *value;
}

bool zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__resize_function__HandEyeCalibrationCalibrate_Event__request(
  void * untyped_member, size_t size)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence * member =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence *)(untyped_member);
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence__fini(member);
  return zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__Sequence__init(member, size);
}

size_t zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__size_function__HandEyeCalibrationCalibrate_Event__response(
  const void * untyped_member)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence * member =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__response(
  const void * untyped_member, size_t index)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence * member =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence *)(untyped_member);
...
void * zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__response(
  void * untyped_member, size_t index)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence * member =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__fetch_function__HandEyeCalibrationCalibrate_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response * item =
    ((const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response *)
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__response(untyped_member, index));
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response * value =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response *)(untyped_value);
  *value = *item;
}

void zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__assign_function__HandEyeCalibrationCalibrate_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response * item =
    ((zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response *)
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__response(untyped_member, index));
  const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response * value =
    (const zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response *)(untyped_value);
  *item = *value;
}

bool zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__resize_function__HandEyeCalibrationCalibrate_Event__response(
  void * untyped_member, size_t size)
{
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence * member =
    (zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence *)(untyped_member);
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence__fini(member);
  return zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event, request),  // bytes offset in struct
    NULL,  // default value
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__size_function__HandEyeCalibrationCalibrate_Event__request,  // size() function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__request,  // get_const(index) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__request,  // get(index) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__fetch_function__HandEyeCalibrationCalibrate_Event__request,  // fetch(index, &value) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__assign_function__HandEyeCalibrationCalibrate_Event__request,  // assign(index, value) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__resize_function__HandEyeCalibrationCalibrate_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event, response),  // bytes offset in struct
    NULL,  // default value
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__size_function__HandEyeCalibrationCalibrate_Event__response,  // size() function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_const_function__HandEyeCalibrationCalibrate_Event__response,  // get_const(index) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__get_function__HandEyeCalibrationCalibrate_Event__response,  // get(index) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__fetch_function__HandEyeCalibrationCalibrate_Event__response,  // fetch(index, &value) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__assign_function__HandEyeCalibrationCalibrate_Event__response,  // assign(index, value) function pointer
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__resize_function__HandEyeCalibrationCalibrate_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_members = {
  "zivid_interfaces__srv",  // message namespace
  "HandEyeCalibrationCalibrate_Event",  // message name
  3,  // number of fields
  sizeof(zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event),
  false,  // has_any_key_member_
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_member_array,  // message members
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_type_support_handle = {
  0,
  &zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_zivid_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Event)() {
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Request)();
  zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Response)();
  if (!zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_type_support_handle.typesupport_identifier) {
    zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t zivid_interfaces__srv__detail__hand_eye_calibration_calibrate__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_service_type_support_handle = {
  ...
  &zivid_interfaces__srv__HandEyeCalibrationCalibrate_Request__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Request_message_type_support_handle,
  &zivid_interfaces__srv__HandEyeCalibrationCalibrate_Response__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Response_message_type_support_handle,
  &zivid_interfaces__srv__HandEyeCalibrationCalibrate_Event__rosidl_typesupport_introspection_c__HandEyeCalibrationCalibrate_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_zivid_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, HandEyeCalibrationCalibrate_Event)()->data;
  }
