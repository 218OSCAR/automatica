...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws/install/zivid_rviz_plugin"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zivid_rviz_plugin/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zivid_rviz_plugin/environment/path.sh"
