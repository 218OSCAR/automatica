...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws/install/moveit_resources_panda_camera_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_resources_panda_camera_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/moveit_resources_panda_camera_description/environment/path.sh"
