...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws/install/panda_moveit_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/panda_moveit_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/panda_moveit_cpp/environment/path.sh"
