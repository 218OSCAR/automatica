...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws/install/zivid_samples"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zivid_samples/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/zivid_samples/environment/path.sh"
