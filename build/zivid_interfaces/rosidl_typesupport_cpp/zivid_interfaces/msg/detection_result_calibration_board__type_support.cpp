...
static const _DetectionResultCalibrationBoard_type_support_symbol_names_t _DetectionResultCalibrationBoard_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zivid_interfaces, msg, DetectionResultCalibrationBoard)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zivid_interfaces, msg, DetectionResultCalibrationBoard)),
  }
};
...
{
  return &::zivid_interfaces::msg::rosidl_typesupport_cpp::DetectionResultCalibrationBoard_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zivid_interfaces, msg, DetectionResultCalibrationBoard)() {
  return get_message_type_support_handle<zivid_interfaces::msg::DetectionResultCalibrationBoard>();
}
