  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zivid_interfaces__msg__HandEyeCalibrationResidual * ros_message = static_cast<const zivid_interfaces__msg__HandEyeCalibrationResidual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zivid_interfaces__msg__HandEyeCalibrationResidual(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zivid_interfaces__msg__HandEyeCalibrationResidual * ros_message = static_cast<zivid_interfaces__msg__HandEyeCalibrationResidual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zivid_interfaces__msg__HandEyeCalibrationResidual(cdr, ros_message);
}
