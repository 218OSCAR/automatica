...
bool cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  eprosima::fastcdr::Cdr & cdr,
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request * ros_message)
{
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_serialize_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t get_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CaptureAndDetectCalibrationBoard_Request__ros_msg_type * ros_message = static_cast<const _CaptureAndDetectCalibrationBoard_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t max_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request * ros_message = static_cast<const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request * ros_message = static_cast<zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
  eprosima::fastcdr::Cdr & cdr,
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
  ...
  // Field name: detection_result
  {
    cdr_deserialize_zivid_interfaces__msg__DetectionResultCalibrationBoard(cdr, &ros_message->detection_result);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_serialize_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t get_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CaptureAndDetectCalibrationBoard_Response__ros_msg_type * ros_message = static_cast<const _CaptureAndDetectCalibrationBoard_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t max_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response * ros_message = static_cast<const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response * ros_message = static_cast<zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(cdr, ros_message);
}
...
using _CaptureAndDetectCalibrationBoard_Event__ros_msg_type = zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  eprosima::fastcdr::Cdr & cdr,
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request__Sequence__fini(&ros_message->request);
    }
    if (!zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response__Sequence__fini(&ros_message->response);
    }
    if (!zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t get_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CaptureAndDetectCalibrationBoard_Event__ros_msg_type * ros_message = static_cast<const _CaptureAndDetectCalibrationBoard_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t max_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
bool cdr_serialize_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t get_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CaptureAndDetectCalibrationBoard_Event__ros_msg_type * ros_message = static_cast<const _CaptureAndDetectCalibrationBoard_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zivid_interfaces
size_t max_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _CaptureAndDetectCalibrationBoard_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event * ros_message = static_cast<const zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(ros_message, cdr);
}

static bool _CaptureAndDetectCalibrationBoard_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event * ros_message = static_cast<zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(cdr, ros_message);
}

static uint32_t _CaptureAndDetectCalibrationBoard_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
      untyped_ros_message, 0));
}

static size_t _CaptureAndDetectCalibrationBoard_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_zivid_interfaces__srv__CaptureAndDetectCalibrationBoard_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_CaptureAndDetectCalibrationBoard_Event = {
  "zivid_interfaces::srv",
  "CaptureAndDetectCalibrationBoard_Event",
  _CaptureAndDetectCalibrationBoard_Event__cdr_serialize,
  _CaptureAndDetectCalibrationBoard_Event__cdr_deserialize,
  _CaptureAndDetectCalibrationBoard_Event__get_serialized_size,
  _CaptureAndDetectCalibrationBoard_Event__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _CaptureAndDetectCalibrationBoard_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CaptureAndDetectCalibrationBoard_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, srv, CaptureAndDetectCalibrationBoard_Event)() {
  return &_CaptureAndDetectCalibrationBoard_Event__type_support;
}
...
static rosidl_service_type_support_t CaptureAndDetectCalibrationBoard__handle = {
  ...
  &_CaptureAndDetectCalibrationBoard_Request__type_support,
  &_CaptureAndDetectCalibrationBoard_Response__type_support,
  &_CaptureAndDetectCalibrationBoard_Event__type_support,
