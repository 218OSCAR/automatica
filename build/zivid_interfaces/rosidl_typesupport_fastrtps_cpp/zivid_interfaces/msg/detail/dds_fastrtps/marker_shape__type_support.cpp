...
#include "zivid_interfaces/msg/detail/marker_shape__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: corners_in_pixel_coordinates
  {
    for (size_t i = 0; i < 4; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.corners_in_pixel_coordinates[i],
        cdr);
    }
  }
  ...
  // Member: corners_in_camera_coordinates
  {
    for (size_t i = 0; i < 4; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.corners_in_camera_coordinates[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: corners_in_pixel_coordinates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.corners_in_pixel_coordinates[index], current_alignment);
    }
  }
  ...
  // Member: corners_in_camera_coordinates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.corners_in_camera_coordinates[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zivid_interfaces::msg::MarkerShape;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zivid_interfaces::msg::MarkerShape *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zivid_interfaces::msg::MarkerShape *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MarkerShape__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zivid_interfaces::msg::MarkerShape *>(
...
static size_t _MarkerShape__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MarkerShape(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MarkerShape__callbacks = {
...
static rosidl_message_type_support_t _MarkerShape__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MarkerShape__callbacks,
...
{
  return &zivid_interfaces::msg::typesupport_fastrtps_cpp::_MarkerShape__handle;
}
