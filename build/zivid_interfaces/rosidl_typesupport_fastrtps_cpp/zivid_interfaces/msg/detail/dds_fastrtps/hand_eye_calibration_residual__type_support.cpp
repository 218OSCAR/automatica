...
#include "zivid_interfaces/msg/detail/hand_eye_calibration_residual__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zivid_interfaces::msg::HandEyeCalibrationResidual & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zivid_interfaces::msg::HandEyeCalibrationResidual & ros_message)
{
  // Member: rotation
  cdr >> ros_message.rotation;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zivid_interfaces::msg::HandEyeCalibrationResidual;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zivid_interfaces::msg::HandEyeCalibrationResidual *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zivid_interfaces::msg::HandEyeCalibrationResidual *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HandEyeCalibrationResidual__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zivid_interfaces::msg::HandEyeCalibrationResidual *>(
...
static size_t _HandEyeCalibrationResidual__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HandEyeCalibrationResidual(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HandEyeCalibrationResidual__callbacks = {
...
static rosidl_message_type_support_t _HandEyeCalibrationResidual__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HandEyeCalibrationResidual__callbacks,
...
{
  return &zivid_interfaces::msg::typesupport_fastrtps_cpp::_HandEyeCalibrationResidual__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zivid_interfaces, msg, HandEyeCalibrationResidual)() {
  return &zivid_interfaces::msg::typesupport_fastrtps_cpp::_HandEyeCalibrationResidual__handle;
}
