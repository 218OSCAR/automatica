...
class Metaclass_CaptureAndDetectCalibrationBoard_Event(type):
    """Metaclass of message 'CaptureAndDetectCalibrationBoard_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__capture_and_detect_calibration_board__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__capture_and_detect_calibration_board__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__capture_and_detect_calibration_board__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__capture_and_detect_calibration_board__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__capture_and_detect_calibration_board__event
...
class CaptureAndDetectCalibrationBoard_Event(metaclass=Metaclass_CaptureAndDetectCalibrationBoard_Event):
    """Message class 'CaptureAndDetectCalibrationBoard_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<zivid_interfaces/CaptureAndDetectCalibrationBoard_Request, 1>',
        'response': 'sequence<zivid_interfaces/CaptureAndDetectCalibrationBoard_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zivid_interfaces', 'srv'], 'CaptureAndDetectCalibrationBoard_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zivid_interfaces', 'srv'], 'CaptureAndDetectCalibrationBoard_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from zivid_interfaces.srv import CaptureAndDetectCalibrationBoard_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, CaptureAndDetectCalibrationBoard_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'CaptureAndDetectCalibrationBoard_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from zivid_interfaces.srv import CaptureAndDetectCalibrationBoard_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, CaptureAndDetectCalibrationBoard_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'CaptureAndDetectCalibrationBoard_Response'"
...
class Metaclass_CaptureAndDetectCalibrationBoard(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _capture_and_detect_calibration_board.Metaclass_CaptureAndDetectCalibrationBoard_Event._TYPE_SUPPORT is None:
                _capture_and_detect_calibration_board.Metaclass_CaptureAndDetectCalibrationBoard_Event.__import_type_support__()
...
class CaptureAndDetectCalibrationBoard(metaclass=Metaclass_CaptureAndDetectCalibrationBoard):
    ...
    from zivid_interfaces.srv._capture_and_detect_calibration_board import CaptureAndDetectCalibrationBoard_Event as Event
