...
ROSIDL_GENERATOR_C_EXPORT
bool zivid_interfaces__srv__infield_correction_compute__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zivid_interfaces.srv._infield_correction_compute.InfieldCorrectionCompute_Event", full_classname_dest, 79) == 0);
  }
  zivid_interfaces__srv__InfieldCorrectionCompute_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!zivid_interfaces__srv__InfieldCorrectionCompute_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create zivid_interfaces__srv__InfieldCorrectionCompute_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    zivid_interfaces__srv__InfieldCorrectionCompute_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!zivid_interfaces__srv__infield_correction_compute__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!zivid_interfaces__srv__InfieldCorrectionCompute_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create zivid_interfaces__srv__InfieldCorrectionCompute_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    zivid_interfaces__srv__InfieldCorrectionCompute_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!zivid_interfaces__srv__infield_correction_compute__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of InfieldCorrectionCompute_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zivid_interfaces.srv._infield_correction_compute");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InfieldCorrectionCompute_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = zivid_interfaces__srv__infield_correction_compute__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = zivid_interfaces__srv__infield_correction_compute__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
