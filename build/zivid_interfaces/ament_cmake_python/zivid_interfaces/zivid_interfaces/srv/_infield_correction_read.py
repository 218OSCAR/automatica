...
class Metaclass_InfieldCorrectionRead_Event(type):
    """Metaclass of message 'InfieldCorrectionRead_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__infield_correction_read__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__infield_correction_read__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__infield_correction_read__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__infield_correction_read__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__infield_correction_read__event
...
class InfieldCorrectionRead_Event(metaclass=Metaclass_InfieldCorrectionRead_Event):
    """Message class 'InfieldCorrectionRead_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<zivid_interfaces/InfieldCorrectionRead_Request, 1>',
        'response': 'sequence<zivid_interfaces/InfieldCorrectionRead_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zivid_interfaces', 'srv'], 'InfieldCorrectionRead_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zivid_interfaces', 'srv'], 'InfieldCorrectionRead_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from zivid_interfaces.srv import InfieldCorrectionRead_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, InfieldCorrectionRead_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'InfieldCorrectionRead_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from zivid_interfaces.srv import InfieldCorrectionRead_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, InfieldCorrectionRead_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'InfieldCorrectionRead_Response'"
...
class Metaclass_InfieldCorrectionRead(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _infield_correction_read.Metaclass_InfieldCorrectionRead_Event._TYPE_SUPPORT is None:
                _infield_correction_read.Metaclass_InfieldCorrectionRead_Event.__import_type_support__()
...
class InfieldCorrectionRead(metaclass=Metaclass_InfieldCorrectionRead):
    ...
    from zivid_interfaces.srv._infield_correction_read import InfieldCorrectionRead_Event as Event
