...
class Init_CaptureAndSave_Event_response
{
public:
  explicit Init_CaptureAndSave_Event_response(::zivid_interfaces::srv::CaptureAndSave_Event & msg)
  : msg_(msg)
  {}
  ::zivid_interfaces::srv::CaptureAndSave_Event response(::zivid_interfaces::srv::CaptureAndSave_Event::_response_type arg)
  {
...
private:
  ::zivid_interfaces::srv::CaptureAndSave_Event msg_;
};

class Init_CaptureAndSave_Event_request
{
public:
  explicit Init_CaptureAndSave_Event_request(::zivid_interfaces::srv::CaptureAndSave_Event & msg)
  : msg_(msg)
  {}
  Init_CaptureAndSave_Event_response request(::zivid_interfaces::srv::CaptureAndSave_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_CaptureAndSave_Event_response(msg_);
  }
...
class Init_CaptureAndSave_Event_info
{
public:
  Init_CaptureAndSave_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CaptureAndSave_Event_request info(::zivid_interfaces::srv::CaptureAndSave_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_CaptureAndSave_Event_request(msg_);
  }
...
template<>
inline
auto build<::zivid_interfaces::srv::CaptureAndSave_Event>()
{
  return zivid_interfaces::srv::builder::Init_CaptureAndSave_Event_info();
}
