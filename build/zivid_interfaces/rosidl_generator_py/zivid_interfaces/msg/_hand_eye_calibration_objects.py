...
class Metaclass_HandEyeCalibrationObjects(type):
    """Metaclass of message 'HandEyeCalibrationObjects'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hand_eye_calibration_objects
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hand_eye_calibration_objects
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hand_eye_calibration_objects
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hand_eye_calibration_objects
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hand_eye_calibration_objects
    ...
    def CALIBRATION_BOARD(self):
        ...
        return Metaclass_HandEyeCalibrationObjects.__constants['CALIBRATION_BOARD']

    @property
    def FIDUCIAL_MARKERS(self):
        """Message constant 'FIDUCIAL_MARKERS'."""
        return Metaclass_HandEyeCalibrationObjects.__constants['FIDUCIAL_MARKERS']


class HandEyeCalibrationObjects(metaclass=Metaclass_HandEyeCalibrationObjects):
    """
    Message class 'HandEyeCalibrationObjects'.
