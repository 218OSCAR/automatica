...
static char zivid_interfaces__msg__MarkerShape__FIELD_NAME__corners_in_pixel_coordinates[] = "corners_in_pixel_coordinates";
static char zivid_interfaces__msg__MarkerShape__FIELD_NAME__corners_in_camera_coordinates[] = "corners_in_camera_coordinates";
static char zivid_interfaces__msg__MarkerShape__FIELD_NAME__id[] = "id";
static char zivid_interfaces__msg__MarkerShape__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field zivid_interfaces__msg__MarkerShape__FIELDS[] = {
  {
    {zivid_interfaces__msg__MarkerShape__FIELD_NAME__corners_in_pixel_coordinates, 28, 28},
    {
  ...
  {
    {zivid_interfaces__msg__MarkerShape__FIELD_NAME__corners_in_camera_coordinates, 29, 29},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_ARRAY,
      4,
      0,
  ...
  {
    {zivid_interfaces__msg__MarkerShape__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {zivid_interfaces__msg__MarkerShape__FIELD_NAME__pose, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription zivid_interfaces__msg__MarkerShape__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {geometry_msgs__msg__Point__TYPE_NAME, 23, 23},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {zivid_interfaces__msg__MarkerShape__FIELDS, 4, 4},
    },
    {zivid_interfaces__msg__MarkerShape__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
zivid_interfaces__msg__MarkerShape__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *zivid_interfaces__msg__MarkerShape__get_individual_type_description_source(NULL),
