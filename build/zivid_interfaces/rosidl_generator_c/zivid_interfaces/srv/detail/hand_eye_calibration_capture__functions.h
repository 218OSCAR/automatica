...
// IWYU pragma: private, include "zivid_interfaces/srv/hand_eye_calibration_capture.h"


#ifndef ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CAPTURE__FUNCTIONS_H_
#define ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CAPTURE__FUNCTIONS_H_
...
/// Initialize srv/HandEyeCalibrationCapture message.
/**
...
/// Finalize srv/HandEyeCalibrationCapture message.
/**
...
/// Create srv/HandEyeCalibrationCapture message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Request__init().
...
/// Destroy srv/HandEyeCalibrationCapture message.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Request__fini()
...
/// Check for srv/HandEyeCalibrationCapture message equality.
/**
...
/// Copy a srv/HandEyeCalibrationCapture message.
/**
...
/// Initialize array of srv/HandEyeCalibrationCapture messages.
/**
...
/// Finalize array of srv/HandEyeCalibrationCapture messages.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Request__fini()
...
/// Create array of srv/HandEyeCalibrationCapture messages.
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/HandEyeCalibrationCapture messages.
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/HandEyeCalibrationCapture message array equality.
/**
...
/// Copy an array of srv/HandEyeCalibrationCapture messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It allocates the memory for the array and calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_zivid_interfaces
...
/**
 * It calls
 * zivid_interfaces__srv__HandEyeCalibrationCapture_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ZIVID_INTERFACES__SRV__DETAIL__HAND_EYE_CALIBRATION_CAPTURE__FUNCTIONS_H_
