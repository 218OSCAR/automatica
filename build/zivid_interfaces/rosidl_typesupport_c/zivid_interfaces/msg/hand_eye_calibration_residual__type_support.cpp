...
static const _HandEyeCalibrationResidual_type_support_symbol_names_t _HandEyeCalibrationResidual_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, msg, HandEyeCalibrationResidual)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, msg, HandEyeCalibrationResidual)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zivid_interfaces, msg, HandEyeCalibrationResidual)() {
  return &::zivid_interfaces::msg::rosidl_typesupport_c::HandEyeCalibrationResidual_message_type_support_handle;
}
