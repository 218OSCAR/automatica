...
static const _CaptureAndDetectMarkers_Request_type_support_symbol_names_t _CaptureAndDetectMarkers_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Request)() {
  return &::zivid_interfaces::srv::rosidl_typesupport_c::CaptureAndDetectMarkers_Request_message_type_support_handle;
}
...
static const _CaptureAndDetectMarkers_Response_type_support_symbol_names_t _CaptureAndDetectMarkers_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Response)() {
  return &::zivid_interfaces::srv::rosidl_typesupport_c::CaptureAndDetectMarkers_Response_message_type_support_handle;
}
...
typedef struct _CaptureAndDetectMarkers_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _CaptureAndDetectMarkers_Event_type_support_ids_t;

static const _CaptureAndDetectMarkers_Event_type_support_ids_t _CaptureAndDetectMarkers_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _CaptureAndDetectMarkers_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _CaptureAndDetectMarkers_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _CaptureAndDetectMarkers_Event_type_support_symbol_names_t _CaptureAndDetectMarkers_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Event)),
  }
};

typedef struct _CaptureAndDetectMarkers_Event_type_support_data_t
{
  void * data[2];
} _CaptureAndDetectMarkers_Event_type_support_data_t;

static _CaptureAndDetectMarkers_Event_type_support_data_t _CaptureAndDetectMarkers_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _CaptureAndDetectMarkers_Event_message_typesupport_map = {
  2,
  "zivid_interfaces",
  &_CaptureAndDetectMarkers_Event_message_typesupport_ids.typesupport_identifier[0],
  &_CaptureAndDetectMarkers_Event_message_typesupport_symbol_names.symbol_name[0],
  &_CaptureAndDetectMarkers_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t CaptureAndDetectMarkers_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_CaptureAndDetectMarkers_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zivid_interfaces, srv, CaptureAndDetectMarkers_Event)() {
  return &::zivid_interfaces::srv::rosidl_typesupport_c::CaptureAndDetectMarkers_Event_message_type_support_handle;
}
...
static const _CaptureAndDetectMarkers_type_support_symbol_names_t _CaptureAndDetectMarkers_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zivid_interfaces, srv, CaptureAndDetectMarkers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zivid_interfaces, srv, CaptureAndDetectMarkers)),
  }
};
...
static const rosidl_service_type_support_t CaptureAndDetectMarkers_service_type_support_handle = {
  ...
  &CaptureAndDetectMarkers_Request_message_type_support_handle,
  &CaptureAndDetectMarkers_Response_message_type_support_handle,
  &CaptureAndDetectMarkers_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, zivid_interfaces, srv, CaptureAndDetectMarkers)() {
  return &::zivid_interfaces::srv::rosidl_typesupport_c::CaptureAndDetectMarkers_service_type_support_handle;
}
