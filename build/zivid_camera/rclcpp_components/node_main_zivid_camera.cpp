...
#define NODE_MAIN_LOGGER_NAME "zivid_camera"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libzivid_camera_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<zivid_camera::ZividCamera>";
